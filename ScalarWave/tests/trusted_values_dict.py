...
trusted_values_dict['InitialData__InitialData__WaveType__PlaneWave___globals'] = {'uu_ID': mpf('2.52358067004083477110217386122'), 'vv_ID': mpf('-0.569645247209539485189673979502')}

# Generated on: 2022-11-11
# Notes: Added 2 to uu, so that relative error is well-defined everywhere.
trusted_values_dict['InitialData__InitialData__WaveType__SphericalGaussian___globals'] = {'uu_ID': mpf('2.36513405713036977689022106748'), 'vv_ID': mpf('0.0563512459589975646763098472872')}
